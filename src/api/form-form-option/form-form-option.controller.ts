...
@Controller()
export class FormFormOptionController extends NestDatumOptionOptionTcpController {
	public columnOptionId = 'formId';
	public columnOptionOptionId = 'formOptionId';

	constructor(
		public transportService: TransportService,
		public service: FormFormOptionService,
	) {
		super();
	}
